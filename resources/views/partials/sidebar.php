 ...
 */
?>
<button type="button" data-modal-open="quick-add-modal" class="quickadd-fab fixed right-5 lg:right-6 z-20 w-14 h-14 rounded-full text-white flex items-center justify-center transition-transform" aria-label="Quick add transaction">
