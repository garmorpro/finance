...
<aside class="sidebar">
    ...
    <div class="flex items-center gap-1 px-4 pb-3" title="Coming soon">
        <span class="sidebar-icon-btn" aria-hidden="true">
        ...
        <span class="sidebar-icon-btn ml-auto" aria-hidden="true">
