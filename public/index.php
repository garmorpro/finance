...
$router->post('/settings/profile/quick-add-key', fn (Request $r): mixed => $profileController->generateQuickAddKey($r));
$router->post('/settings/profile/quick-add-key/revoke', fn (Request $r): mixed => $profileController->revokeQuickAddKey($r));
...
$router->post('/quick-add', fn (Request $r): mixed => $transactionController->storeQuickAdd($r));
$router->post('/quick-add/unlock', fn (Request $r): mixed => $transactionController->unlockQuickAdd($r));
$router->post('/quick-add/forget', fn (Request $r): mixed => $transactionController->forgetQuickAddDevice($r));
...
$router->get('/budgets/review', fn (Request $r): mixed => $budgetController->showReview($r));
