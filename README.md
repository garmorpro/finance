...
Not yet built: real SMTP (password reset and invitation links are logged instead of emailed — see below) and PDF export for reports (CSV export is available on `/reports`).
